...
export const MENUS: Menu[] = [
  {
    ...
    items: [
      ...
      { label: "Open Recent", separatorAfter: true },
      { label: "Save", shortcut: "Ctrl+S" },
      { label: "Save As…", shortcut: "Ctrl+Shift+S", separatorAfter: true },
      { label: "Import…" },
      { label: "Export As…", shortcut: "Ctrl+Shift+E", separatorAfter: true },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Delete Layer", separatorAfter: true },
