...
export default function CanvasArea({
  ...
  useEffect(() => {
    ...
    paintRef.current = {
      ...
      getLayerImageCanvas: (id) => engine.getLayerImageCanvas(id),
      getMaskImageCanvas: (id) => engine.getMaskImageCanvas(id),
      getFrameSourceImageCanvas: (id) => engine.getFrameSourceImageCanvas(id),
