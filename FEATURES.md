...
- **File/export:** Save/Open **`.gproj`**; **Export As** PNG · JPEG · WebP · AVIF (quality + alpha, feature-detected); **Export SVG** of vector/text layers; **Print** `Ctrl+P`; **Recents** list; EXIF **Metadata** panel.
